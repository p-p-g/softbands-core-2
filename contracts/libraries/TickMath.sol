...
library TickMath {
    ...
    /// @notice Tick spacing used by the protocol (each effective tick = 10 Uniswap ticks ≈ 0.1%)
    ...
    /// @notice Rounds a tick down to the nearest tick spacing boundary
    function roundTickDown(int24 tick) internal pure returns (int24) {
